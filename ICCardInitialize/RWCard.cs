...
public class RWCard
{
    ...
    /// </summary>
    /// <param name="icdev">被打开串口的句柄</param>
    /// <param name="Adr">M1卡块地址（1～63）；ML卡页地址（0～11）</param>
    ...
    /// <param name="Adr">M1卡块地址（1～63）；  ML卡页地址（2～11）</param>
    ...
    /// <returns></returns>
    public static string ReadICCardData(IntPtr icdev, short Adr, int begin, int len)
    {
        byte[] data = new byte[32];
        int j=rf_read_hex(icdev, Adr, data);
        string strNO = "";
